...
public class MovingParts {
	...
	public void generate() {
		...
		listCars.add(new Car(this, 5, 3, Profil.respectful, 0, 2, 20, this.simulation.getStructureParts().getRoad(0).getLane(0)));
		listCars.add(new Car(this, 5, 3, Profil.crazy, 0, 1, 10, this.simulation.getStructureParts().getRoad(0).getLane(1)));
		listCars.add(new Car(this, 5, 3, Profil.crazy, 0, 2, 10, this.simulation.getStructureParts().getRoad(1).getLane(0)));
		listCars.add(new Car(this, 5, 3, Profil.crazy, 0, 2, 10, this.simulation.getStructureParts().getRoad(1).getLane(1)));
